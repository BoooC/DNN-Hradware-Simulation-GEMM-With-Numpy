...
kernel1_path = 'weight/kernel1.txt' 
kernel2_path = 'weight/kernel2.txt' 
kernel3_path = 'weight/kernel3.txt' 
kernel4_path = 'weight/kernel4.txt' 
kernel5_path = 'weight/kernel5.txt' 

ifmap_path  = 'ifmap/ifmap.txt' 
output_path = 'ifmap/ofmap.txt'
